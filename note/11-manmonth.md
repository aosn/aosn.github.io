...
* 全く新しいソフトウェア産業 - パッケージソフトウェア
  * 第4世代言語とは・・・ PL/SQL などの手続き型言語の次の世代の言語の総称らしい (参考: [4GL](https://ja.wikipedia.org/wiki/4GL))
  * ベンダーロックインの良い道具になってる気もする・・・
  * [クラウドに最適化した 4GL アプリケーションを開発してデプロイする](https://www.ibm.com/developerworks/jp/cloud/library/cl-3gl4glclouddev/index.html) ← 3GL と 4GL がごっちゃになってるような・・・
  * 結局昔のバズワードなのかもね
  * OS の種類はさらに収斂してる (DEC とかないし)
