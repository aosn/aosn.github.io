...
* **P295** REST vs. RPC... [マイクロサービスアーキテクチャ](/workshop/8-microservices/)にも言及があったね

→ マイクロサービスアーキテクチャ P54 あたり

> RPC の中核となる考え方は、リモート呼び出しの複雑さを隠すことです。
> しかし、多くの RPC 実装は隠しすぎています。ある種の RPC がリモートメソッド呼び出しをローカルメソッド呼び出しのように見せようとすることで、この2つが大きく異なるという事実が隠されています。
>
> (以下略 & 後に続く節)
> 
> - 4.6.1 技術的結合
